...
\begin{enumerate}
\item Les carrés et les rectangles et les ronds aussi numérotés de la figure ci-dessous représentent les positions de deux blocs à des intervalles de $0.20$s. Les blocs se déplacent vers la droite. Comparez l'accélération des deux blocs. 
\begin{center}
